...
const Cardy = ({ title, imageSrc, alt, price }) => {
    return(
        <Card
        as={motion.span}
        color="#333"
        ...
        >
          ...
          <CardBody>
              ...
              <Heading as='h4' alignItems="flex-start" fontFamily={'Karla'} fontWeight='bold' fontSize={['12','14','18']}>{title}</Heading>
              <Heading as='h4' fontFamily={'Karla'} fontWeight='medium' fontSize={['8','12','16']}>{price}</Heading>
              </HStack>
              <Heading as='h4' fontFamily={'Karla'} fontWeight='medium' fontSize={['8','12','16']}>Artist</Heading>
            </CardBody>
        </Card>
    )
}
